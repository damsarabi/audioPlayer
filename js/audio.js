  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      createPlayer: {
        markup: '\
          ...
          <input type="range" class="setVolume" id="rngVolume" min="0" max="1" step="0.01" value="1">\
    ...
    attachEvents: function(wrapper, audio) {
      ...
      var player = audio.settings.createPlayer,
          ...
          setVolume = getByClass(player.setVolumeClass, wrapper);

      container[audiojs].events.addListener(playPause, 'click', function(e) {
        audio.playPause.apply(audio);
      });

      container[audiojs].events.addListener(setVolume, 'click', function(e) {
